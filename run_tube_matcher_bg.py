...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Lanza el matcher web de tubos y escribe la URL a un archivo.")
    ...
    parser.add_argument("--url-file", type=str, required=True, help="Archivo donde escribir la URL del matcher al quedar listo.")
    return parser
